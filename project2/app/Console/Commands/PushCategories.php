...
class PushCategories extends Command
{
     ...
     * @var string
     */
    protected $description = 'Categories pushed to Project 1';
    ...
    public function handle()
    {
        ...
        if ($categories->isEmpty()) {
            $this->info('No categories to push to Project 1.');
            return;
        }

        // Get the base URL for Project 1 from the .env file
        $baseUrl = env('PROJECT1_URL');

        // Send categories to Project 1
        ...
        if ($response->successful()) {
            ...
            $this->error('Failed to push categories to Project 1.');
        }
    }
}
